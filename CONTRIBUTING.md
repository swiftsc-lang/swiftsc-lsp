# Contributing to SwiftSC (swiftsc-lsp)
...
## Language Server
*   **Capabilities**: Extend `tower-lsp` traits for new protocol features.
*   **Responsiveness**: Ensure handlers are async and non-blocking.
*   **Integration**: Test changes against VS Code or other LSP clients.
